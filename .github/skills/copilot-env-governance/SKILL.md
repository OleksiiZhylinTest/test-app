...
2. Prefer existing `.github/summaries/**` and local `.github/**` assets before broader repo docs, and escalate to `docs/development/assistant_customization_governance.md` only when you need the full review checklist or are changing the ownership model itself.
